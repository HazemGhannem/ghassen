 ...
 * @author MSI GAMMING
 */
public class AllMenu extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllMenu(Resources res) {
...
//        });
        ...
        for (Menu fi : m) {
            ...
            Label l2 = new Label("Description : " + fi.getDescp(), "SmallLabel");
            Label l3 = new Label("Prix : " + fi.getPrix(), "SmallLabel");
            Label l4 = new Label("Image  : " + fi.getImage(), "RedLabel");
            ...
            Modif.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    new ModifierMenu(res, current, fi).show();
                }
            });
            Supprimer.addActionListener(new ActionListener() {

                public void actionPerformed(ActionEvent evt) {
                    if (Dialog.show("Confirmation", "Voulez vous supprimer cette Menu ?", "Oui", "Annuler")) {

                        if (ServiceMenu.getInstance().deleteMenu(fi.getId())) {
